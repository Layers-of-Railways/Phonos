...
public record RequestEnderMusicBoxUploadSessionPacket(BlockPos pos, String name) implements C2SPacket {
    ...
    public void handle(ServerPlayerEntity sender) {
        ...
        if (world.getBlockEntity(pos) instanceof EnderMusicBoxBlockEntity entity) {
            Long streamId;
            if (entity.canModifyStreams(sender) && (streamId = entity.allocateStreamId(name)) != null) {
                ServerCustomAudio.beginUploadSession(sender, streamId);
